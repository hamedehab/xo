...
function end(num1,num2,num3){
    ...
    document.getElementById('item'+num1).style.background = '#00008b';
    document.getElementById('item'+num2).style.background = '#00008b';
    document.getElementById('item'+num3).style.background = '#00008b';
